...
def test_basic():
    global user_answer_basic, lblquestion_basic, lblimage_basic, r1_basic, r2_basic, r3_basic, r4_basic, questions_basic_test, indexes_basic, img_list_basic, answers_basic, answer_choice_basic_test
...
def test_boolean():
    global ques_boolean, radio_var_boolean, user_answer_boolean, boolean_test, ques_boolean, indexes_boolean, answer_choice_boolean_test, questions_booleantest, r1_boolean, r2_boolean, r3_boolean, r4_boolean, lblquestion_boolean, lblimage_boolean, img_list_boolean, answers_boolean, pques_b_2
...
def test_modyul():
    global user_answer_modyul, lblquestion_modyul, lblimage_modyul, r1_modyul, r2_modyul, r3_modyul, r4_modyul, questions_modyul_test, indexes_modyul, img_list_modyul, answers_modyul, answer_choice_modyul_test
    ...
    if "easy" == (dicc.get("mode")):
        ...
        Label(modyul_test, text="Proficiency Test for MODYUL Module", font=("Helvetica", 18)).pack()
...
def test_func():
    global user_answer_func, lblquestion_func, lblimage_func, r1_func, r2_func, r3_func, r4_func, questions_func_test, indexes_func, img_list_func, answers_func, answer_choice_func_test
    ...
    if "easy" == (dicc.get("mode")):
        ...
        Label(func_test, text="Proficiency Test for FUNC Module", font=("Helvetica", 18)).pack()
...
def test_sequence():
    global user_answer_sequence, lblquestion_sequence, lblimage_sequence, r1_sequence, r2_sequence, r3_sequence, r4_sequence, questions_sequence_test, indexes_sequence, img_list_sequence, answers_sequence, answer_choice_sequence_test
    ...
    if "easy" == (dicc.get("mode")):
        ...
        Label(sequence_test, text="Proficiency Test for Sequencetion module", font=("Helvetica", 18)).pack()
        ...
        Label(sequence_test, text="Proficiency Test for SEQUENCE Module", font=("Helvetica", 18)).pack()
...
def test_string():
    global strings, radio_var_string, pques_str_b, user_answer_str, questions_string_test, indexes_str, lblquestion_string, lblimage_string, img_list_string, answer_choice_string_test, r1_string, r2_string, r3_string, r4_string, answers_string
    ...
    if "easy" == (dicc.get("mode")):
        ...
        Label(string_test, text="Proficiency Test for Boolean Module", font=("Helvetica", 18)).pack()
...
Using raw strings completely ignores all escape charcters.""",
    ...
    pques_string_1 = pques_string_1.resize((167, 77), Image.ANTIALIAS)
...
def test_dfs():
    global user_answer_dfs, lblquestion_dfs, lblimage_dfs, r1_dfs, r2_dfs, r3_dfs, r4_dfs, questions_dfs_test, indexes_dfs, img_list_dfs, answers_dfs, answer_choice_dfs_test
    ...
    if "easy" == (dicc.get("mode")):
        ...
        Label(dfs_test, text="Proficiency Test for DFS Module", font=("Helvetica", 18)).pack()
...
def test_gui():
    global user_answer_gui, lblquestion_gui, lblimage_gui, r1_gui, r2_gui, r3_gui, r4_gui, questions_gui_test, indexes_gui, img_list_gui, answers_gui, answer_choice_gui_test, gui
...
def test_numpy():
    global user_answer_numpy, lblquestion_numpy, lblimage_numpy, r1_numpy, r2_numpy, r3_numpy, r4_numpy, questions_numpy_test, indexes_numpy, img_list_numpy, answers_numpy, answer_choice_numpy_test
    ...
    if "easy" == (dicc.get("mode")):
        ...
        Label(numpy_test, text="Proficiency Test for Dictionaries, Files and Sets module",
...
def test_exep():
    global excep, user_answer_excep, lblquestion_exep, lblimage_exep, r1_exep, r2_exep, r3_exep, r4_exep, answer_choice_exep_test, indexes_excep, questions_exep_test, img_list_exep, answers_exep
    ...
    if "easy" == (dicc.get("mode")):
        ...
        Label(excep_test, text="Proficiency Test for Boolean Module", font=("Helvetica", 18)).pack()
...
def dash():
    ...
    file_menu.add_command(label="Open IDE", command=open_ide)
    ...
    lbl = LabelFrame(screen, padx=80, pady=80)
    ...
    b_image = Button(lbl, image=basic_prog, command=start_basic_module)
    ...
    f_image = Button(lbl, image=func, command=start_func_module)
    f_image.image = func
    ...
    m_image = Button(lbl, image=modle, command=start_modyul_module)
    m_image.image = modle
    ...
    nump_button = Button(lbl, image=nump, command=start_numpy_module)
    ...
    bool_button = Button(lbl, image=boolean, command=start_boolean_module)
    ...
    seq_b = Button(lbl, image=sequences, command=start_sequence_module)
    ...
    string_b = Button(lbl, image=string, command=start_strings_module)
    ...
    dicc_b = Button(lbl, image=dict, command=start_dfs_module)
    dicc_b.image = dict
    ...
    exep_b = Button(lbl, image=exep, command=start_exceptions_module)
    exep_b.image = exep
    ...
    graph_b = Button(lbl, image=graph_i, command=start_gui_module)
    ...
    pgbar = Progressbar(lbl, length=500, orient=HORIZONTAL, maximum=100, value=0)
    pgbar.grid(row=19, column=4)


def successful_login():
    messagebox.showinfo("STATUS", "LOG IN SUCCESSFULL!")
    screen2.destroy()
    dash()
...
def mscreen():
    ...
    screen.title("ATLAS")
    global main_L
    main_L = Label(screen, text="Welcome to ATLAS!" + "\n", borderwidth=2, relief="solid", bg="blue", width="50",
                   height="2",
                   font=("Helvetica", 13))
    main_L.pack()
